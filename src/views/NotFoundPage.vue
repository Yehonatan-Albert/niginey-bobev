      ...
      <div class="not-found">
        ...
        <div class="piano" dir="ltr">
          <div class="octave" v-for="octave in octaves" :key="octave">
            <div v-for="key in keys" :key="key.note + octave" :class="['key', key.type]" :data-note="key.note + octave" @mousedown="startTone(key.note + octave)" @mouseup="stopTone" @contextmenu.prevent></div>
          </div>
        </div>
